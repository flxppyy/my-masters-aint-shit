...
# --- NQ annual % returns you posted (1988–2025 YTD) ---
...
plt.title(f"NQ Annual Returns Distribution (2009–2025 YTD)\n"
...
out_path = Path(r"C:\Users\>USERNAME<\Downloads\nq_returns_bell_curve.png")
